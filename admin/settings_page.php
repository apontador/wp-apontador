...
<?php if ($oauth_secret): ?>
  ...
  <div >
    ...
    <p>
      ...
      <?php printf(_n("%d review", "%d reviews", $user['user']['stats']['reviews']), $user['user']['stats']['reviews']); ?><br />
      <?php printf(_n("%d photo", "%d photos", $user['user']['stats']['photos']), $user['user']['stats']['photos']); ?><br />
